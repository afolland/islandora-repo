...
class SelfDepositCreateForm extends FormBase {
  ...
  public static function create(ContainerInterface $container) {
    ...
    #$instance->requestHandler = $container->get('create_a_repository_item');
    return $instance;
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    #\Drupal::logger('self_deposit')->notice(implode(key($options)));
    $this->createItem($webform_submission);
    /*
    $message_handler_id = $form_state->getValue('message_handler_id');
    $handler = $webform_submission->getWebform()->getHandler($message_handler_id);
   ...
   * {@inheritdoc}
   */
  private function createItem(WebformSubmissionInterface $webform_submission) {
